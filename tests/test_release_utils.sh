...
expected_agent="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code"
...
expected_main="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code"
...
expected_all="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code playwright"
assert_eq "default returns all 9" "$expected_all" "$default_all"
