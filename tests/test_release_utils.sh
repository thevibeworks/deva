...
expected_agent="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code opencode"
...
expected_main="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code opencode"
...
expected_all="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code opencode playwright"
assert_eq "default returns all 10" "$expected_all" "$default_all"
