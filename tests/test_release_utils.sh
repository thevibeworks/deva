...
expected_agent="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code opencode pi"
...
expected_main="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code opencode pi"
...
expected_all="cctrace ccx claude-code codex copilot-api gemini-cli grok-cli kimi-code opencode pi playwright"
assert_eq "default returns all 11" "$expected_all" "$default_all"
