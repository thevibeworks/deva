...
Run Codex, Claude Code, Gemini, Grok, Kimi, opencode, pi, and dsh inside Docker without pretending
...
- a Docker-based launcher for Codex, Claude, Gemini, Grok, Kimi, opencode, pi, and dsh
