...
Run Codex, Claude Code, Gemini, Grok, Kimi, and opencode inside Docker without pretending
...
- a Docker-based launcher for Codex, Claude, Gemini, Grok, Kimi, and opencode
