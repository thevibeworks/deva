...
Run Codex, Claude Code, Gemini, Grok, Kimi, opencode, pi, dsh, and Cursor inside Docker without pretending
...
- a Docker-based launcher for Codex, Claude, Gemini, Grok, Kimi, opencode, pi, dsh, and cursor
