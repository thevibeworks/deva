...
echo "  - $INSTALL_DIR/agents/kimi.sh"
echo "  - $INSTALL_DIR/agents/opencode.sh"
echo "  - $INSTALL_DIR/agents/pi.sh"
echo "  - $INSTALL_DIR/agents/dsh.sh"
echo "  - $INSTALL_DIR/agents/cursor.sh"
...
echo "     deva.sh kimi -- --help"
echo "     deva.sh opencode -- --help"
echo "     deva.sh pi -- --help"
echo "     deva.sh dsh -- --help"
echo "     deva.sh cursor -- --help"
echo "     deva.sh shell"
echo ""
